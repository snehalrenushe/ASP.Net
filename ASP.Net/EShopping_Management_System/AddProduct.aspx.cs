...
public partial class AddProduct : System.Web.UI.Page
{
    ...
    {
        if (tb_Product_Name.Text != "" && tb_Price.Text != "" && tb_sell_Price.Text != "" && tb_Quantity.Text != "" && tb_Description.Text != "" && tb_P_Detail.Text != "" && tb_Mat_Care.Text != "" )
        {
            using (SqlConnection con = new SqlConnection(CS))
            {
                ...
                for (int i = 0; i < cbl_Size.Items.Count; i++)
                {
                    ...
                    {
                        Int64 Size_ID = Convert.ToInt64(cbl_Size.Items[i].Value);
                        int Quantity = Convert.ToInt32(tb_Quantity.Text);

                        SqlCommand cmd2 = new SqlCommand("insert into Product_Size_Quantity values('" + Product_ID + "','" + Size_ID + "','" + Quantity + "')", con);
                ...
                if (fuImg01.HasFile)
                {
                    string SavePath = Server.MapPath("~/img/Product_Images/") + Product_ID;
                ...
                if (fuImg02.HasFile)
                {
                    ...
                    SqlCommand cmd4 = new SqlCommand("insert into Product_Images values('" + Product_ID + "','" + tb_Product_Name.Text.ToString().Trim() + "02" + "','" + Extention + "')", con);
                ...
                if (fuImg03.HasFile)
                {
                    ...
                    SqlCommand cmd5 = new SqlCommand("insert into Product_Images values('" + Product_ID + "','" + tb_Product_Name.Text.ToString().Trim() + "03" + "','" + Extention + "')", con);
                ...
                if (fuImg04.HasFile)
                {
                    ...
                    SqlCommand cmd6 = new SqlCommand("insert into Product_Images values('" + Product_ID + "','" + tb_Product_Name.Text.ToString().Trim() + "04" + "','" + Extention + "')", con);
                ...
                if (fuImg05.HasFile)
                {
                    ...
                    SqlCommand cmd7 = new SqlCommand("insert into Product_Images values('" + Product_ID + "','" + tb_Product_Name.Text.ToString().Trim() + "05" + "','" + Extention + "')", con);
